 ...
 */
class ZhYandexMapViewMapMarkers extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JHtmlSidebar::addFilter(
			JText::_('COM_ZHYANDEXMAP_MAP_USER_IMAGESELECT'),
			'filter_icontype',
		...
		JHtmlSidebar::addFilter(
			JText::_('COM_ZHYANDEXMAP_MAPMARKER_FILTER_PLACEMARK_GROUP'),
			'filter_markergroup',
		...
		JHtmlSidebar::addFilter(
			JText::_('COM_ZHYANDEXMAP_MAPMARKER_FILTER_USER'),
	...
	protected function getSortFields()
	{
		return array(
			...
			'h.id' => JText::_('COM_ZHYANDEXMAP_MAPMARKER_HEADING_ID'),
			'h.title' => JText::_('COM_ZHYANDEXMAP_MAPMARKER_HEADING_TITLE'),
			'h.access' => JText::_('JGRID_HEADING_ACCESS'),			
			'h.published' => JText::_('COM_ZHYANDEXMAP_MAPMARKER_HEADING_PUBLISHED')
		);
	}

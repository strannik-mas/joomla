...
<tr>
	<th width="10" class="nowrap center hidden-phone">
		<?php echo JHtml::_('grid.sort', 'COM_ZHYANDEXMAP_MAPMARKER_HEADING_ID', 'h.id', $listDirn, $listOrder); ?>
	</th>
	<th width="20" class="hidden-phone">
		<input type="checkbox" name="checkall-toggle" value="" title="<?php echo JText::_('JGLOBAL_CHECK_ALL'); ?>" onclick="Joomla.checkAll(this)" />
	</th>			
	<th class="title">
		<?php echo JHtml::_('grid.sort', 'COM_ZHYANDEXMAP_MAPMARKER_HEADING_TITLE', 'h.title', $listDirn, $listOrder); ?>
	</th>
	<th>
	...
	<th width="5" class="nowrap center">
		<?php echo JHtml::_('grid.sort', 'COM_ZHYANDEXMAP_MAPMARKER_HEADING_PUBLISHED', 'h.published', $listDirn, $listOrder); ?>
	</th>
	<th>

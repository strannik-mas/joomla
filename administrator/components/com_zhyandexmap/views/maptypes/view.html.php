 ...
 */
class ZhYandexMapViewMapTypes extends JViewLegacy
{
	protected $state;
	...
	protected function getSortFields()
	{
		return array(
			...
			'h.id' => JText::_('COM_ZHYANDEXMAP_MAPTYPE_HEADING_ID'),
			'h.title' => JText::_('COM_ZHYANDEXMAP_MAPTYPE_HEADING_TITLE'),
			'h.published' => JText::_('COM_ZHYANDEXMAP_MAPTYPE_HEADING_PUBLISHED')
		);
	}

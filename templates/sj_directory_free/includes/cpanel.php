        ...
        <div class="cpanel-theme">
            ...
            <div class="panel-group">
                ...
                <div class="panel-theme-color">
                    ...
                    <span data-placement="left" title="Cyan"     class="theme-color cyan<?php echo ($templateColor=='cyan')?' active':'';?>">Cyan</span>
                    <span data-placement="top" title="Indigo"      class="theme-color indigo<?php echo ($templateColor=='indigo')?' active':'';?>">Indigo</span>
                    <span data-placement="top" title="Orange"  class="theme-color orange<?php echo ($templateColor=='orange')?' active':'';?>">Orange</span>
                    <span data-placement="top" title="Cerulean"  class="theme-color cerulean<?php echo ($templateColor=='cerulean')?' active':'';?>">Cerulean</span>
                </div>
            </div>

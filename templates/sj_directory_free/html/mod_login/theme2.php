...
<?php if ($type == 'login') : ?>
	<ul class="yt-loginform2">	
        <li class="yt-login">
			...
			<div class="wel-login"><span><?php echo JText::_('WELCOME_LOGIN'); ?></span></div>
			<a class="login-switch hidden-xs" data-toggle="modal" href="#myLogin" title="<?php  echo JText::_('JLOGIN');?>">
			  	<?php echo JText::_('JLOGIN');?>
			</a>
			<a class="login-switch hidden-sm hidden-md hidden-lg" href="<?php echo JRoute::_("index.php?option=com_users&view=login");?>" title="<?php  echo JText::_('JLOGIN');?>">

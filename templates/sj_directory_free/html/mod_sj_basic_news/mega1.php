...
?>
	...
	<div id="<?php echo $uniquied?>" class="sj-basic-news">
		<div class="bj-items row">
			...
			?>
			<div class="bj-item col-md-6 cf <?php echo $show_line.' '.$last_class; ?>">
				<?php if($img){?>
				<div class="bs-image">
					<a class="bs-img" href="<?php echo $item->link ?>" title="<?php echo $item->title; ?>" <?php echo SjBasicNewsHelper::parseTarget($params->get('link_target')); ?>>
						<?php
                    ...
                    <div class="bs-date" data-author="<?php echo  $item->author ;?>">
                            <span class="number"><?php echo  JHTML::_('date', $item->created,JText::_('d')) ;?></span>

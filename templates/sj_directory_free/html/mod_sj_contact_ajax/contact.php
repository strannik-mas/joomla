...
<?php } ?>
	...
	<div class="contact-ajax" id="<?php echo $tag_id; ?>"><!--<![endif]-->
		<div class="ctajax-wrap">
			...
			<div class="ctajax-element contact-form">
			...
			<div class="ctajax-element contact-info">
				<div class="el-inner">
					
					<div class="el-info-contact">
						<?php $mobile = trim($list->telephone);
						if ($mobile != '') {
						?>
							<div class="info-cf info-mobie">
								<i class="fa fa-headphones"></i>
								<h3 data-label="<?php echo JText::_('TEL_LABEL') ?>"><?php echo JText::_('TEL_LABEL') ?></h3>
								<span class="info-labels"> <?php echo $mobile; ?></span>
							</div>
						<?php } ?>
						...
						if ($address != '') {
						?>
							<div class="info-cf info-address">
								<i class="fa fa-map-marker"></i>
								<h3 data-label="<?php echo JText::_('ADD_LABEL') ?>"><?php echo JText::_('ADD_LABEL') ?></h3>
								<span class="info-labels"><?php echo $address; ?></span>
							</div>
						<?php } ?>
						
						<?php $mail_to = trim($list->email_to);
						if ($mail_to != '') {
						?>
							<div class="info-cf info-mail">
								<i class="fa fa-envelope-o"></i>
								<h3 data-label="<?php echo JText::_('MAIL_LABEL') ?>"><?php echo JText::_('MAIL_LABEL') ?></h3>
								<a href="mailto:<?php echo $mail_to; ?>" class="info-labels"><?php echo $mail_to; ?></a>
							</div>
						<?php } ?>
					</div>
				</div>

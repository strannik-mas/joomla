...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2-recent <?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
  	<?php 
  		$count_item = 0;
  	?>
    <?php foreach ($items as $key=>$item):	$count_item = $count_item + 1; ?>

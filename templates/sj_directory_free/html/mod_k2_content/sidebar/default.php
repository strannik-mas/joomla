...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2-popular <?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
	...
	<a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>">
      ...
      <div class="moduleItemIntrotext">
	      ...
	      <a class="img item-image moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
	      		<?php 	

...
abstract class comZhYandexMapData
{
	...
	public static function getRouters($id, $routelistid, $exroutelistid, $grouplistid, $categorylistid) 
	{
				...
				)
			{
				...
				if ($exroutelistid != "")
				{
					$tmp_expl_ids = str_replace(';',',', $exroutelistid);
			...
			else
			{
				if ($routelistid != "")
				{
					$tmp_pl_ids = str_replace(';',',', $routelistid);
			...
			if ((int)$markergroupctlmarker == 1)
			{
				if ((int)$markergroupctlpath != 0)
				{
						...
						)
					{
						...
						if ($expathlistid != "")
						{
							$tmp_expl_ids = str_replace(';',',', $expathlistid);
					...
					else
					{
						if ($pathlistid != "")
						{
							$tmp_pl_ids = str_replace(';',',', $pathlistid);
						...
						if ($grouplistpathid != "")
						{
							$tmp_grp_ids = str_replace(';',',', $grouplistpathid);
						...
						{
							$tmp_cat_ids = str_replace(';',',', $categorylistpathid);

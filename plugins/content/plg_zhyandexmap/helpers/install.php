...
abstract class plgZhYandexMapInstallHelper
{
    ...
    {
		return plgZhYandexMapInstallHelper::getExtensionObjectParams(self::$extension_type, self::$extension_name, self::$extension_folder);
    }
	
	public static function getExtensionID()
	{
		return plgZhYandexMapInstallHelper::getExtensionIDParams(self::$extension_type, self::$extension_name, self::$extension_folder);
	}

	public static function getExtensionEnabledStatus()
	{
		return plgZhYandexMapInstallHelper::getExtensionEnabledStatusParams(self::$extension_type, self::$extension_name, self::$extension_folder);
	}
	
	public static function getExtensionObjectParams($type, $name, $folder)
	{
		plgZhYandexMapInstallHelper::addLog('Executing: getExtensionObject', 1, 0, 1);
		
		plgZhYandexMapInstallHelper::addLog('type:'. $type, 0, 0, 0);
		plgZhYandexMapInstallHelper::addLog('name:'. $name, 0, 0, 0);
		plgZhYandexMapInstallHelper::addLog('folder:'. $folder, 0, 0, 0);
		...
		plgZhYandexMapInstallHelper::addLog('done getExtensionObject', 1, 0, -1);
	...
	{
		plgZhYandexMapInstallHelper::addLog('Executing: getExtensionID', 1, 0, 1);
		$extObj = plgZhYandexMapInstallHelper::getExtensionObject($type, $name, $folder);
		...
		plgZhYandexMapInstallHelper::addLog('done getExtensionID', 1, 0, -1);
		return $extensionid;
	...
	{
		plgZhYandexMapInstallHelper::addLog('Executing: getExtensionEnabledStatus', 1, 0, 1);
		$extObj = plgZhYandexMapInstallHelper::getExtensionObject($type, $name, $folder);
		...
		plgZhYandexMapInstallHelper::addLog('done getExtensionEnabledStatus', 1, 0, -1);
